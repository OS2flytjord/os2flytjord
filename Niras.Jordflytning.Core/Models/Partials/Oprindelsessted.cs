...
namespace Niras.Jordflytning.Core.Models
{
  ...
  [MetadataType(typeof(OprindelsesstedMetaData))]
  public partial class Oprindelsessted
  {
    public Oprindelsessted ShallowCopy()
    {
      //Shallow copy til brug ved log ændringerne på anmeldelsen.
      //return (Oprindelsessted)this.MemberwiseClone();
  ...
  public class OprindelsesstedMetaData
  {
  }
}
