...
select COUNT(*) from Anmeldelse where AnmelderId is null

select top 1 * from person where Email='kve@niras.dk'

update Anmeldelse set AnmelderId='2BB90CF6-DEE4-45F2-AE65-EE103B8A9A43' where AnmelderId is null;
...
DROP INDEX [dbo].[Anmeldelse].[IDX_Anmeldelse_8_FK]
GO


ALTER TABLE [dbo].[Anmeldelse] ALTER COLUMN [AnmelderId] UNIQUEIDENTIFIER NOT NULL
GO
