...
ALTER TABLE [dbo].[Jord] ALTER COLUMN [Bemaerkning] NVARCHAR(max)
GO


ALTER TABLE [dbo].[Jord] ALTER COLUMN [JordarbejdeBeskrivelse] NVARCHAR(max)
GO


ALTER TABLE [dbo].[Jord] ALTER COLUMN [TidligereErhvervsaktivitet] NVARCHAR(500)
GO


ALTER TABLE [dbo].[Jord] ALTER COLUMN [LinkTilGodkendtAnmeldelse] NVARCHAR(1024)
GO
