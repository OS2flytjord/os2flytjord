...
ALTER TABLE [dbo].[Advis] DROP CONSTRAINT [Besked_Advis]
GO
...
ALTER TABLE [dbo].[Anmeldelse] DROP CONSTRAINT [Anmeldelse_Anmeldelse]
GO
...
ALTER TABLE [dbo].[JordKlassifikationType] DROP CONSTRAINT [LandsdelType_JordKlassifikationType]
GO
...
ALTER TABLE [Kommunikation] DROP CONSTRAINT [Person_KommunikationFra]
GO


ALTER TABLE [Kommunikation] DROP CONSTRAINT [Person_KommunikationTil]
GO


ALTER TABLE [Kommunikation] DROP CONSTRAINT [Anmeldelse_Kommunikation]
GO


ALTER TABLE [Kommunikation] DROP CONSTRAINT [Besked_Kommunikation]
GO


ALTER TABLE [Alarm] DROP CONSTRAINT [Anmeldelse_Alarm]
GO


ALTER TABLE [Alarm] DROP CONSTRAINT [Person_Alarm]
GO


ALTER TABLE [Alarm] DROP CONSTRAINT [Besked_Alarm]
GO


ALTER TABLE [Delta] DROP CONSTRAINT [Log_Delta]
GO
...
ALTER TABLE [Delta] DROP CONSTRAINT [DEF_Delta_Id]
GO


ALTER TABLE [Delta] DROP CONSTRAINT [PK_Delta]
GO
...
ALTER TABLE [Alarm] DROP CONSTRAINT [DEF_Alarm_Id]
GO
...
ALTER TABLE [Kommunikation] DROP CONSTRAINT [DEF_Kommunikation_Id]
GO


ALTER TABLE [Kommunikation] DROP CONSTRAINT [PK_Kommunikation]
GO
...
ALTER TABLE [dbo].[Vognlaes] DROP CONSTRAINT [DEF_Vognlaes_Afvist]
GO
...
/* ---------------------------------------------------------------------- */
/* Drop table "LandsdelType"                                              */
/* ---------------------------------------------------------------------- */

/* Drop constraints */

ALTER TABLE [LandsdelType] DROP CONSTRAINT [DEF_LandsdelType_Aktiv]
GO


ALTER TABLE [LandsdelType] DROP CONSTRAINT [PK_LandsdelType]
GO
...
ALTER TABLE [Besked] DROP CONSTRAINT [DEF_Besked_Id]
GO


ALTER TABLE [Besked] DROP CONSTRAINT [PK_Besked]
GO
...
ALTER TABLE [dbo].[Person] DROP CONSTRAINT [DEF_Person_FrivilligeAdvis]
GO
...
ALTER TABLE [dbo].[Person] DROP CONSTRAINT [TUC_Person_1]
GO
...
ALTER TABLE [dbo].[Kommune] DROP CONSTRAINT [TCC_Kommune_1]
GO
