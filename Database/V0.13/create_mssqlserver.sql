...
CREATE TABLE [dbo].[Kommune] (
    ...
    CONSTRAINT [TCC_Kommune_1] CHECK (kommunenr>100)
)
GO
...
CREATE TABLE [dbo].[Person] (
    ...
    CONSTRAINT [TUC_Person_1] UNIQUE ([BrugerId])
)
GO
...
CREATE TABLE [LandsdelType] (
    ...
    [Aktiv] BIT CONSTRAINT [DEF_LandsdelType_Aktiv] DEFAULT 1 NOT NULL,
    CONSTRAINT [PK_LandsdelType] PRIMARY KEY ([Id])
)
GO
...
CREATE TABLE [dbo].[Jord] (
    ...
    [Bemaerkning] NVARCHAR(max) COLLATE Danish_Norwegian_CI_AS,
    [JordarbejdeBeskrivelse] NVARCHAR(max) COLLATE Danish_Norwegian_CI_AS,
    [TidligereErhvervsaktivitet] NVARCHAR(max) COLLATE Danish_Norwegian_CI_AS,
...
CREATE TABLE [dbo].[StatusAnmeldelse] (
    ...
    [AnmeldelseId] UNIQUEIDENTIFIER NOT NULL,
    [StatusAnmeldelseTypeId] UNIQUEIDENTIFIER NOT NULL,
    [PersonId] UNIQUEIDENTIFIER,
    [Tid] DATETIME NOT NULL,
...
CREATE NONCLUSTERED INDEX [IDX_Vognlaes_2] ON [dbo].[Vognlaes] ([Afvist])
GO


CREATE  INDEX [IDX_Vognlaes_3_FK] ON [dbo].[Vognlaes] ([LastbilId])
GO


CREATE  INDEX [IDX_Vognlaes_4_FK] ON [dbo].[Vognlaes] ([AnmeldelseId])
GO
...
CREATE TABLE [Delta] (
    [Id] UNIQUEIDENTIFIER CONSTRAINT [DEF_Delta_Id] DEFAULT newId() NOT NULL,
