...
ALTER TABLE [AndenOprindJordType] DROP CONSTRAINT [Oprindelsessted_AndenOprindJordType]
GO
...
ALTER TABLE [AndenOprindJordType] DROP CONSTRAINT [DEF_AndenOprindJordType_Id]
GO


ALTER TABLE [AndenOprindJordType] DROP CONSTRAINT [PK_AndenOprindJordType]
GO
...
ALTER TABLE [JordflytningType] DROP CONSTRAINT [DEF_JordflytningType_Id]
GO


ALTER TABLE [JordflytningType] DROP CONSTRAINT [PK_JordflytningType]
GO
...
ALTER TABLE [MiljoeklasseType] DROP CONSTRAINT [DEF_MiljoeklasseType_Id]
GO
