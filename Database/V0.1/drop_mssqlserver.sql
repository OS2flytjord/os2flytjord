...
ALTER TABLE [Oprindelsessted] DROP CONSTRAINT [OprindelsesstedKlassifikationType_Oprindelsessted]
GO


ALTER TABLE [Anmelder] DROP CONSTRAINT [Anmeldelse_Anmelder]
GO
...
ALTER TABLE [Transportoer] DROP CONSTRAINT [Anmeldelse_Transportoer]
GO
...
ALTER TABLE [Jordtip] DROP CONSTRAINT [Anmeldelse_Jordtip]
GO
...
ALTER TABLE [Vognlaes] DROP CONSTRAINT [Anmeldelse_Vognlaes]
GO


ALTER TABLE [Raadgiver] DROP CONSTRAINT [Anmeldelse_Raadgiver]
GO


ALTER TABLE [Raadgiver] DROP CONSTRAINT [Person_Raadgiver]
GO
...
ALTER TABLE [Interesant] DROP CONSTRAINT [Person_Interesant]
GO
...
/* ---------------------------------------------------------------------- */
/* Drop table "Raadgiver"                                                 */
/* ---------------------------------------------------------------------- */

/* Drop constraints */

ALTER TABLE [Raadgiver] DROP CONSTRAINT [PK_Raadgiver]
GO
