...
/* Project file:          JordflytningV0.9.dez                            */
/* Project name:                                                          */
/* Author:                                                                */
/* Script type:           Database creation script                        */
/* Created on:            2013-03-22 08:10                                */
/* ---------------------------------------------------------------------- */
...
CREATE TABLE [dbo].[Lastbil] (
    ...
    [MiljoeklasseTypeId] UNIQUEIDENTIFIER,
...
CREATE TABLE [AndenOprindJordType] (
    [Id] UNIQUEIDENTIFIER CONSTRAINT [DEF_AndenOprindJordType_Id] DEFAULT newid() NOT NULL,
    [OprindelsesstedId] UNIQUEIDENTIFIER,
    [Navn] NVARCHAR(40) NOT NULL,
    [Aktiv] BIT NOT NULL,
    [Sortering] NUMERIC(2),
    CONSTRAINT [PK_AndenOprindJordType] PRIMARY KEY ([Id])
)
GO


CREATE  INDEX [IDX_AndenOprindJordType_1_FK] ON [AndenOprindJordType] ([OprindelsesstedId])
GO
...
CREATE TABLE [dbo].[Jord] (
    ...
    [Bemaerkning] NVARCHAR(500),
    [JordarbejdeBeskrivelse] NVARCHAR(100),
    [TidligereErhvervsaktivitet] NVARCHAR(100),
    [IntaktJord] BIT,
    [AkutBaggrund] NVARCHAR(100),
...
CREATE  INDEX [IDX_Anmeldelse_7_FK] ON [dbo].[Anmeldelse] ([OprindelsesstedId])
GO


CREATE  INDEX [IDX_Anmeldelse_8_FK] ON [dbo].[Anmeldelse] ([JordId])
GO
...
ALTER TABLE [dbo].[Jord] ADD CONSTRAINT [JordflytningType_Jord] 
    FOREIGN KEY ([JordflytningTypeId]) REFERENCES [JordflytningType] ([Id])
GO
...
ALTER TABLE [dbo].[Lastbil] ADD CONSTRAINT [MiljoeklasseType_Lastbil] 
    FOREIGN KEY ([MiljoeklasseTypeId]) REFERENCES [MiljoeklasseType] ([Id])
GO
...
ALTER TABLE [AndenOprindJordType] ADD CONSTRAINT [Oprindelsessted_AndenOprindJordType] 
    FOREIGN KEY ([OprindelsesstedId]) REFERENCES [dbo].[Oprindelsessted] ([Id])
GO
