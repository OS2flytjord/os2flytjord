...
{
	[TestFixture]
	public class JordForureningBusinessTests
	{
		...
		public JordForureningBusinessTests()
		{
			// Init Ninject kernel
		...
		public void GetJordForureningTest()
		{
			...
			var list = areal.GetMiljoePortalList();
		...
		//	var areal = _business.GetJordForurening(oprSted, aarhusGuid);

		//	var klassType = areal.GetMiljoePortalKlassifikation();
		...
		//	var areal = _business.GetJordForurening(oprSted, aarhusGuid);
		//	var list = areal.GetMiljoePortalKlassifikationList();

		//	//var klassType = list.Find(e => e.MiljoeportalOmkKey == 3);

		//	//Assert.IsNotNull(klassType, "Der burde være een klassifikation med typen 'analalyse pligt'");
		//}
		...
		//	var areal = _business.GetJordForurening(oprSted, aarhusGuid);
		//	var list = areal.GetExceptionList();

		//	var klassType = list.Find(e => e.Contains("SystemFejl: Kunne ikke finde"));

		//	Assert.IsNotNull(klassType, "Der burde være een klassifikation med typen 'SystemFejl: K'");
		//}
		...
		//	var skalAnmeldes = areal.HasAnmeldePligt;
		...
		//	var areal = _business.GetJordForurening(oprSted, aarhusGuid);
		//	var list = areal.GetForureningsDescriptionList();
		...
		//	// Act
		//	var areal = _business.GetJordForurening(oprSted, _aarhusGuid);

		//	// Assert
		//	var skalAnmeldes = areal.HasAnmeldePligt;
		//	Assert.IsTrue(skalAnmeldes);

		//	var kls = areal.GetMiljoePortalKlassifikation();
		//	Assert.IsNotNull(kls);
		//	Assert.AreEqual((short) ForureningsKlasse.JordLetForurenet, kls.Priotering);
		//}
		...
		//	var kls = areal.GetMiljoePortalKlassifikation();
		//	Assert.IsNotNull(kls);
		//	Assert.AreEqual((short) ForureningsKlasse.JordKraftigForurenet, kls.Priotering);
		//}
		...
		//	var kls = areal.GetMiljoePortalKlassifikation();
		//	Assert.IsNotNull(kls);
		//	Assert.AreEqual((short) ForureningsKlasse.JordRen, kls.Priotering);
		//}
